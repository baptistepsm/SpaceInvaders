...
#### Fonctionnalité n°2 : Dimensionner le vaiseau (en cours d'implémentation)  
- Story n°1 : Positionner un nouveau vaisseau avec une dimension donnée 
- Story n°2 : Faire en sorte qu'il soit impossible de positionner un nouveau vaisseau qui déborde de l'espace de jeu (en cours)
